...
<table width="366" border="0" align="center">
  ...
  <tr>
    ...
    <td><input name="m3" type="text" id="m3" onChange="return lnam()" readonly="readonly" value="Tk<?php echo $mat['price'];?>">  </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><label>
      <select name="sel2" id="sel2">
        ...
        <option value="BRACK" selected>BRACK</option>
        <option value="BIKASH">BIKASH</option>
        <option value="DHAKA">DHAKA</option>
        <option value="MUSTER CARD">MUSTER CARD</option>
        <option value="SCB"> SC Bank</option>
      </select>
    </label></td>
  </tr>
  <tr>
